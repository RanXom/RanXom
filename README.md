...
i enjoy building software close to the system—from terminal applications and linux tooling to backend services and full-stack web apps.
...
- 🌐 full-stack systems with Next.js, TypeScript & Spring Boot
...
- a text editor written from scratch
- a terminal Pomodoro application (available on AUR)
